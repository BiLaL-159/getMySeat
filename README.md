...
> [!NOTE]
> GetMySeat is under active development. The catalogue, access control and Holds work today; Bookings and payments are next. See the [roadmap](#roadmap).
...
- [x] **Foundations:** Docker Compose stack, Flyway, CI with Testcontainers
- [x] **Catalogue and access control:** Keycloak JWTs, Organizer Applications, Venue approval, Events, Shows, Section Prices, public browsing
...
- [ ] **Observability and service extraction:** Prometheus, Grafana, OpenTelemetry, Notification extracted as its own service
- [ ] **Kubernetes:** manifests for the whole system on a local `kind` cluster
